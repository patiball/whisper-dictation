...
- Weryfikacja: Po wdrożeniu zmian zbieramy metryki start_delay/start_silence_ms. Jeśli w ≥20% przypadków występuje >30 ms ciszy na starcie lub brak kotwicy, wracamy do pełnej diagnostyki zgodnie z `memory-bank/archive/2026-02-09-windows11-focus/plan-audio-clipping-root-cause.md`.
