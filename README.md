...
- [Installation](#installation)
  - [Windows 11 MVP Setup](#windows-11-mvp-setup)
- [Usage](#usage)
  - [Keyboard Shortcuts](#️-keyboard-shortcuts)
  - [Windows 11 MVP Runtime](#windows-11-mvp-runtime)
...
On Windows 11, install PortAudio via your Python distribution/wheels and ensure microphone permissions are enabled in system settings.
...
If you run `-m medium` for the first time, Whisper downloads the model automatically and caches it locally.
...
poetry run python whisper-dictation-fast.py -m large --k_double_cmd  # Best Quality
```
...
### Windows 11 MVP Runtime
```powershell
# Default Windows hotkey is ctrl+alt
python whisper-dictation.py -m medium -k ctrl+alt
```

What to expect on Windows 11:
- App runs without macOS `rumps` dependency.
- A tray icon is shown with `Start Recording`, `Stop Recording`, and `Exit`.
