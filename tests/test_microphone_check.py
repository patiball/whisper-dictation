...
class TestMicrophoneCheckBasics:
    ...
    def test_microphone_permission_denied(self, mock_sounddevice):
        ...
        with patch('sounddevice.query_devices', side_effect=PermissionError("Access denied")):
            def check_microphone_availability():
                try:
                    import sounddevice as sd
                    devices = sd.query_devices()
        ...
        def fallback_microphone_check():
            ...
            try:
                ...
                try:
                    ...
                    return 'Built-in Microphone' in result.stdout or 'Microphone' in result.stdout
                except Exception:
                    return False
            except Exception:
                return False
