...
**Purpose**: Benchmark Python Whisper vs whisper.cpp candidates on Windows
**Usage**:
```bash
...
### `setup_whisper_openvino_windows.ps1`
**Purpose**: Build and configure whisper.cpp with OpenVINO support on Windows
**Usage**:
```powershell
